...
go build -trimpath -ldflags="-X main.version=2.8.0" -o ./bin/mcp-docker ./cmd/mcp-docker
...
```powershell
go build -trimpath -ldflags="-X main.version=2.8.0" -o .\bin\mcp-docker.exe .\cmd\mcp-docker
