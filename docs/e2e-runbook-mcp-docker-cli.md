...
- review-raven:
  - 既存登録があれば削除: claude mcp remove --scope user review-raven
  - 追加: claude mcp add --transport http --scope user review-raven http://127.0.0.1:8080/mcp/review-raven
- github:
